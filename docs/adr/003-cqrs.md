...
Aplika has two fundamentally different types of operations:
...
- [Aplika readme — CQRS section](../readme.md#cqrs)
- [Aplika readme — Dashboard example](../readme.md#example-dashboard)
