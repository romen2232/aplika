---
name: phpspec-tdd
description: "Trigger: phpspec, phpspec spec file, TDD, domain test, backend unit test, red green refactor. Drive backend domain behavior with PHPSpec first and pick the correct Jobify test level."
license: Apache-2.0
metadata:
  author: "romen2232"
  version: "1.0"
