...
description: "Trigger: run tests, install dependencies, composer, npm, start environment, execute command, behat, playwright. All Aplika local commands run through Docker Compose, never on the host."
license: Apache-2.0
metadata:
  author: "romen2232"
  version: "1.0"
